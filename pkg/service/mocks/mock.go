...
import (
	...
	todo_app_gin "github.com/gavrylenkoIvan/todo-app-gin"
...
func (m *MockAuthorization) CreateUser(user todo_app_gin.User) (int, error) {
	m.ctrl.T.Helper()
...
func (m *MockTodoList) Create(userId int, list todo_app_gin.TodoList) (int, error) {
	m.ctrl.T.Helper()
...
func (m *MockTodoList) GetAll(userId int) ([]todo_app_gin.TodoList, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAll", userId)
	ret0, _ := ret[0].([]todo_app_gin.TodoList)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockTodoList) GetById(userId, listId int) (todo_app_gin.TodoList, error) {
	m.ctrl.T.Helper()
...
func (m *MockTodoList) Update(userId, listId int, input todo_app_gin.UpdateListInput) error {
	m.ctrl.T.Helper()
...
// Create mocks base method.
func (m *MockTodoItem) Create(userId, listId int, item todo_app_gin.TodoItem) (int, error) {
	m.ctrl.T.Helper()
...
// GetAll mocks base method.
func (m *MockTodoItem) GetAll(userId, listId int) ([]todo_app_gin.TodoItem, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAll", userId, listId)
	ret0, _ := ret[0].([]todo_app_gin.TodoItem)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// GetById mocks base method.
func (m *MockTodoItem) GetById(userId, itemId int) (todo_app_gin.TodoItem, error) {
	m.ctrl.T.Helper()
...
// Update mocks base method.
func (m *MockTodoItem) Update(userId, itemId int, input todo_app_gin.UpdateItemInput) error {
	m.ctrl.T.Helper()
